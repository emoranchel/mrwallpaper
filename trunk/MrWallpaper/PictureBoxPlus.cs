...
namespace ImageBrowser2 {
    public class PictureBoxPlus : PictureBox {
            ...
            get {
                if (!imageBorders.HasValue) {
                    ...
                    if (original != null) {
                        ...
                        r = MakeAspectRect(new Rectangle(0,0,this.Width,this.Height),new Size(original.Width,original.Height));
        ...
        protected override void OnMouseMove(MouseEventArgs e) {
            if (mouseDown) {
                ...
                if (moveRect) {
                    ...
                    if (aspectRatio != 0) {
                        mouseRect = MakeAspectRect(mouseRect, aspectRatio);
                    }
                }
                this.Invalidate();
            }
        ...
        private Rectangle MakeAspectRect(Rectangle mouseRect, double ar) {
            Rectangle r = new Rectangle();
            r.X = mouseRect.X;
            r.Y = mouseRect.Y;
            if (ar > 1.0) {
        ...
        private Rectangle MakeAspectRect(Rectangle mouseRect, Size original) {
            return MakeAspectRect(mouseRect, (double)original.Width / original.Height);
        }
